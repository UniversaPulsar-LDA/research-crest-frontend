...
export default function Index() {
  ...
  const handleVerifyOtp = () => {
    if (otp.length === 6) {
      alert("OTP Verified! Now you can set a new password.");
    } else {
      ...
      <section className="i-hero">
        ...
        <div className="i-hero-right">
          <div className="login-card">
            ...
            {/* Step 2: Register View (Your Compact Form) */}
            {view === "register" && (
              <>
            ...
            {/* Forgot Password & OTP Views remain same as your code */}
            {view === "forgot" && (
              <>
                <h2>Forgot Password?</h2>
                <input type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                <button className="login-btn" onClick={handleSendCode}>Send Reset Code</button>
                <div className="login-links">
            ...
            {view === "otp" && (
              <>
                <h2>Verify OTP</h2>
                <input type="text" maxLength={6} placeholder="000000" value={otp} onChange={(e) => setOtp(e.target.value.replace(/\D/g, ""))} />
                <button className="login-btn" onClick={handleVerifyOtp}>Verify and Proceed</button>
              </>
            )}
          </div>
        </div>
